function AboutHeader() {
  ...
  return (
    ...
    <div className="w-screen h-auto justify-center items-center flex">
        ...
        max-[680px]:flex max-[680px]:flex-col max-[680px]:h-[1080px] max-[680px]:w-screen ">
            <div className="flex justify-center">

                <div className="flex flex-col justify-between items-start gap-[35px]
                max-[680px]:items-center max-[680px]:text-center max-[680px]:gap-[20px] max-[680px]:mt-[80px] max-[680px]:mb-[40px]">
                    <p className="font-montserrat font-[700] text-[16px] leading-[24px] tracking-[0.1] text-[#252B42]
                    max-[680px]:hidden">ABOUT COMPANY</p>
                    ...
                    max-[680px]:max-w-[280px]">
                    We know how large objects will act, but things on a small scale <p className="hidden max-[680px]:block">just do not act that way.</p>
                    </p>
    ...
    max-[680px]:h-[290px] max-[680px]:flex-col max-[680px]:mt-[50px]">
        <div className="w-full max-w-[400px] h-[150px] flex flex-col justify-center items-start gap-[20px] 
        max-[680px]:items-center max-[680px]:text-center max-[680px]:max-w-[269px]">
        ...
        max-[680px]:items-center max-[680px]:text-left max-[680px]:max-w-[350px]">
    ...
    <div className="w-screen h-auto flex items-center justify-center gap-[10px] mt-[100px] ">
        ...
        max-[680px]:flex-col max-[680px]:h-auto max-[680px]:items-center">
