function ProductCards() {
    ...
    const cards1 = [
        {
            img:'./src/pictures/product1.jpg',
            name:'Graphic Design',
            descript:'English Department',
            price:'$16.48',
            salePrice:'$6.48'
        },
        {img:'./src/pictures/product2.jpg',
            name:'Graphic Design',
            descript:'English Department',
            price:'$16.48',
            salePrice:'$6.48'
    ...
    const cards2 = [
        {
            img:'./src/pictures/product5.jpg',
            name:'Graphic Design',
            descript:'English Department',
            price:'$16.48',
            salePrice:'$6.48'
        },
        {img:'./src/pictures/product6.jpg',
            name:'Graphic Design',
            descript:'English Department',
            price:'$16.48',
            salePrice:'$6.48'
