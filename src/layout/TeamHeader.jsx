    ...
    return (
        ...
        <div className="w-screen h-auto flex flex-col justify-center items-center">
            <div className="flex flex-col justify-center items-center mt-[100px] mb-[100px] gap-[24px]">
                ...
                max-[680px]:text-[40px] max-[680px]:leading-[50px]"
            ...
            <div className="w-[90%] h-[550px] gap-[10px] grid grid-cols-2 grid-rows-1 justify-center items-center mb-[100px]
            max-[680px]:flex max-[680px]:flex-col max-[680px]:w-full max-[680px]:h-auto max-[680px]:gap-[10px]">
