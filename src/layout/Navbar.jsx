...
useEffect(() => {
  ...
  return (
    <>
      <div className="w-[1440px] h-[136px] bg-[#FFFFFF] flex flex-col justify-between">
          {/* Dark navbar */}
          <div className="w-[1440px] h-[58px] bg-[#252B42] relative flex justify-between relative">
          ...
          {/* Light navbar */}
          <div className="w-[1440px] h-[58px] bg-[#FFFFFF]  flex justify-between items-center relative">

            {/* Brand */}
              <div className="w-[108px] h-[58px] flex relative left-[38px] justify-start">
                <a 
              ...
              {/* NavMenu */}
              <div className="w-[1175px] h-[58px]  flex relative justify-between items-center">
