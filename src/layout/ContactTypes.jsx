...
function ContactTypes() {
  ...
  return (
    <>
        <div className="w-screen h-auto flex flex-col items-center justify-center gap-[80px] mt-[20px] mb-[20px]">
            <div className="max-w-[2000px] w-[80%] h-[150px] flex flex-col justify-center items-center gap-[10px]">
                <h5 className="font-montserrat text-[700] text-[14px] leading-[24px] tracking-[0.2px] text-center  text-[#252B42]">VISIT OUR OFFICE</h5>
                <h2 className="font-montserrat text-[700] text-[40px] leading-[50px] tracking-[0.2px] text-center  text-[#252B42]">We help small businesses with big ideas</h2>
            </div>
